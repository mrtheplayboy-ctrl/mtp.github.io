...
<style>
        ...
        img {
            ...
            height: auto;
            cursor: pointer;
            box-shadow: 0 0 20px 10px #f20079; /* Свечение */
            border-radius: 10px; /* Скругление углов */
        }
    </style>
<body>
    <img src="jonkla.jpg" id="myImage"/>
    <audio src="The Jonkler.mp3" loop="" id="myAudio">
